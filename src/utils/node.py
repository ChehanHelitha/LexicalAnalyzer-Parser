...
class Node:
    ...
    def insert_child(self,child):
        ...
        self.childern.insert(0,child) #insert a child to the current node's childeren list
    ...
    def remove_child(self,child):
        ...
        if child in self.childern:
            self.childern.remove(child) #If the child exists remove the child from current node's childeren list
        else:
